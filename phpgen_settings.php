...
{
    $result = array();
    $result[] = array('caption' => 'Tbl Animal', 'short_caption' => 'Tbl Animal', 'filename' => 'tbl_animal.php', 'name' => 'tbl_animal', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Tbl Campanha Vacinacao', 'short_caption' => 'Tbl Campanha Vacinacao', 'filename' => 'tbl_campanha_vacinacao.php', 'name' => 'tbl_campanha_vacinacao', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Tbl Certificado Vacina', 'short_caption' => 'Tbl Certificado Vacina', 'filename' => 'tbl_certificado_vacina.php', 'name' => 'tbl_certificado_vacina', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Tbl Endeereco Proprietario', 'short_caption' => 'Tbl Endeereco Proprietario', 'filename' => 'tbl_endeereco_proprietario.php', 'name' => 'tbl_endeereco_proprietario', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Tbl Vacina', 'short_caption' => 'Tbl Vacina', 'filename' => 'tbl_vacina.php', 'name' => 'tbl_vacina', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
