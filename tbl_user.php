 ...
 */
    ...
    class tbl_userPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Tbl User');
            $this->SetMenuLabel('Tbl User');
            ...
            $this->dataset->addFields(
                array(
                    new IntegerField('id_user', true, true, true),
    ...
    try
    {
        $Page = new tbl_userPage("tbl_user", "tbl_user.php", GetCurrentUserPermissionsForPage("tbl_user"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("tbl_user"));
