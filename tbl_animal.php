 ...
 */
    ...
    class tbl_animal_tbl_certificado_vacinaPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_tbl_animal_tbl_certificado_vacina_animal_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('animal', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_animal_tbl_certificado_vacina_animal_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_animal_tbl_certificado_vacina_campanha_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('campanha', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_animal_tbl_certificado_vacina_campanha_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Animal', 'animal', 'animal_cpf_proprietario', 'edit_tbl_animal_tbl_certificado_vacina_animal_search', $editor, $this->dataset, $lookupDataset, 'id_animal', 'cpf_proprietario', '');
            ...
            $editColumn = new DynamicLookupEditColumn('Campanha', 'campanha', 'campanha_nome_campanha', 'edit_tbl_animal_tbl_certificado_vacina_campanha_search', $editor, $this->dataset, $lookupDataset, 'id_campanha', 'nome_campanha', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('cpf_proprietario', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Animal', 'animal', 'animal_cpf_proprietario', 'multi_edit_tbl_animal_tbl_certificado_vacina_animal_search', $editor, $this->dataset, $lookupDataset, 'id_animal', 'cpf_proprietario', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('nome_campanha', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Campanha', 'campanha', 'campanha_nome_campanha', 'multi_edit_tbl_animal_tbl_certificado_vacina_campanha_search', $editor, $this->dataset, $lookupDataset, 'id_campanha', 'nome_campanha', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('cpf_proprietario', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Animal', 'animal', 'animal_cpf_proprietario', 'insert_tbl_animal_tbl_certificado_vacina_animal_search', $editor, $this->dataset, $lookupDataset, 'id_animal', 'cpf_proprietario', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('nome_campanha', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Campanha', 'campanha', 'campanha_nome_campanha', 'insert_tbl_animal_tbl_certificado_vacina_campanha_search', $editor, $this->dataset, $lookupDataset, 'id_campanha', 'nome_campanha', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('cpf_proprietario', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_animal_tbl_certificado_vacina_animal_search', 'id_animal', 'cpf_proprietario', null, 20);
            ...
            $lookupDataset->setOrderByField('nome_campanha', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_animal_tbl_certificado_vacina_campanha_search', 'id_campanha', 'nome_campanha', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('cpf_proprietario', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_animal_tbl_certificado_vacina_animal_search', 'id_animal', 'cpf_proprietario', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_campanha', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_animal_tbl_certificado_vacina_campanha_search', 'id_campanha', 'nome_campanha', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('cpf_proprietario', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_animal_tbl_certificado_vacina_animal_search', 'id_animal', 'cpf_proprietario', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_campanha', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_animal_tbl_certificado_vacina_campanha_search', 'id_campanha', 'nome_campanha', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('cpf_proprietario', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_animal_tbl_certificado_vacina_animal_search', 'id_animal', 'cpf_proprietario', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_campanha', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_animal_tbl_certificado_vacina_campanha_search', 'id_campanha', 'nome_campanha', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class tbl_animalPage extends Page
    {
        protected function DoBeforeCreate()
        {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_animal_endereco_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('endereco', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_animal_endereco_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('tbl_animal.tbl_certificado_vacina')->HasViewGrant() && $withDetails)
            {
            //
            // View column for tbl_animal_tbl_certificado_vacina detail
            //
            $column = new DetailColumn(array('id_animal'), 'tbl_animal.tbl_certificado_vacina', 'tbl_animal_tbl_certificado_vacina_handler', $this->dataset, 'Tbl Certificado Vacina');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Endereco', 'endereco', 'endereco_rua', 'edit_tbl_animal_endereco_search', $editor, $this->dataset, $lookupDataset, 'id_endereco', 'rua', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('rua', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Endereco', 'endereco', 'endereco_rua', 'multi_edit_tbl_animal_endereco_search', $editor, $this->dataset, $lookupDataset, 'id_endereco', 'rua', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('rua', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Endereco', 'endereco', 'endereco_rua', 'insert_tbl_animal_endereco_search', $editor, $this->dataset, $lookupDataset, 'id_endereco', 'rua', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new tbl_animal_tbl_certificado_vacinaPage('tbl_animal_tbl_certificado_vacina', $this, array('animal'), array('id_animal'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('tbl_animal.tbl_certificado_vacina'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('tbl_animal.tbl_certificado_vacina'));
            $detailPage->SetHttpHandlerName('tbl_animal_tbl_certificado_vacina_handler');
            $handler = new PageHTTPHandler('tbl_animal_tbl_certificado_vacina_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('rua', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_animal_endereco_search', 'id_endereco', 'rua', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('rua', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_animal_endereco_search', 'id_endereco', 'rua', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('rua', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_animal_endereco_search', 'id_endereco', 'rua', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('rua', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_animal_endereco_search', 'id_endereco', 'rua', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new tbl_animalPage("tbl_animal", "tbl_animal.php", GetCurrentUserPermissionsForPage("tbl_animal"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("tbl_animal"));
